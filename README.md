...
- Semantic autocomplete preserves LSP `label`, `kind`, `filterText`,
  `sortText`, `insertText`, snippet bodies, provider `detail`, and provider
  `documentation`, so generic server results can match, classify, rank,
