...
- Duplicate line/selection (Ctrl+Shift+D), delete current line (Ctrl+Shift+K), join line (Ctrl+J), move line up/down (Alt+↑ / Alt+↓), word-wise motion and deletion (Ctrl+←/→, Ctrl+Backspace/Delete), smart Home, Shift+motion selection
