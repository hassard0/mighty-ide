...
- Prompt fallback keyboard and submit routes report when the bottom prompt is
  already closed
- **Live Markdown preview (Ctrl+Shift+V)** — themed, live-updating split-pane render with ordered-list overflow preserving list structure
