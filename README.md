...
- Semantic autocomplete preserves LSP `label`, `kind`, `filterText`,
  `sortText`, `insertText`, snippet bodies, and provider `detail`, so generic
  server results can match, classify, rank, display, insert, and describe
